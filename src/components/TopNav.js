                ...
                <MDBCollapse isOpen={this.state.collapse} navbar>
                    <MDBNavbarNav left>
                        <MDBNavItem active={this.state.active === "home"}>
                            <MDBNavLink to="/" onClick={() => this.setActive("home")}>Home</MDBNavLink>
                        </MDBNavItem>
                        <MDBNavItem active={this.state.active === "map"}>
                            <MDBNavLink to="/map" onClick={() => this.setActive("map")}>Map</MDBNavLink>
                        </MDBNavItem>
                        <MDBNavItem active={this.state.active === "chart"}>
                            <MDBNavLink to="/chart" onClick={() => this.setActive("chart")}>Chart</MDBNavLink>
                        </MDBNavItem>
                    </MDBNavbarNav>
                </MDBCollapse>
            </MDBNavbar>
